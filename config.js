...
window.NG_CONTRACT_CONFIG = {
  ...
  PRODUCTS: [
    ...
    { name: '골프 50분 레슨 8회',  qty: '8회 / 2개월',  cat: 'golf' },
    { name: '골프 50분 레슨 20회', qty: '20회 / 4개월', cat: 'golf' },
    { name: '골프 50분 레슨 30회', qty: '30회 / 4개월', cat: 'golf' },
    { name: '골프 타석 1개월',     qty: '1개월', cat: 'golf' },
    { name: '골프 타석 3개월',     qty: '3개월', cat: 'golf' },
    { name: '골프 타석 6개월',     qty: '6개월', cat: 'golf' },
    { name: '사물함',              qty: '',      cat: 'etc' }
  ],

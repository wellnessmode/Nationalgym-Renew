...
- **용산 1호점 = 서초 2호점 PT 약관 동일** → 공통 템플릿 1개 (`branch IS NULL`, version `2026-06-22`)
- 피티앤골프 3호점은 PT 미운영, golf/combo 약관도 공통
...
ceo@nationalgym.kr 확인 없이 1번으로 가정하면 용산 1호점 약관이 구버전으로 방치된다. 2026-06-22 작업 시 처음에 1번으로 잘못 만들었다가 사용자 정정으로 2번으로 되돌린 사례 있음. **기본 가정은 2번**.
